  ...
  converter: {
    ...
    setup: {
      PATCH_GAME_SETUP_BY_ID_V1_REQUEST_TO_GAME_SETUP_UPDATE_QUERY_CONVERTER:
        Symbol('PatchGameSetupByIdV1RequestToGameSetupUpdateQueryConverter'),
      POST_GAME_SETUP_V1_REQUEST_TO_GAME_SETUPS_CREATION_QUERY_CONVERTER:
        Symbol('PostGameSetupV1RequestToGameSetupsCreationQueryConverter'),
      POST_GAME_SETUPS_SEARCHES_V1_REQUEST_TO_GAME_SETUP_FIND_QUERY_CONVERTER:
        Symbol('PostGameSetupsSearchesV1RequestToGameSetupFindQueryConverter'),
    },
  },
  reqHandler: {
    card: {
